...
class SuperAdminUsersTab extends StatelessWidget {
  ...
  Widget _userTile(String name, String role, String status, Color roleColor) {
    return Container(
      ...
      child: Row(children: [
        CircleAvatar(radius: 20, backgroundColor: roleColor.withAlpha(38), child: Icon(Icons.person, color: roleColor, size: 20)),
        const SizedBox(width: 12),
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(name, style: AppTheme.label(size: 14)),
          Row(children: [
            Container(padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2), decoration: BoxDecoration(color: roleColor.withAlpha(26), borderRadius: BorderRadius.circular(AppRadius.sm)),
