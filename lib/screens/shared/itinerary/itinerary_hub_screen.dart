...
class ItineraryHubScreen extends StatelessWidget {
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                Expanded(child: ElevatedButton.icon(onPressed: () {}, icon: const Icon(Icons.add, size: 18), label: const Text('Create New'), style: ElevatedButton.styleFrom(backgroundColor: AppColors.primary))),
              ]),
            ),
            ...
            _itineraryTile('Davao City Explorer', '5 stops · 3 days', 'Active', AppColors.primary),
            _itineraryTile('Siargao Surf Trip', '4 stops · 5 days', 'Upcoming', AppColors.accent),
            _itineraryTile('Lake Sebu Cultural Tour', '3 stops · 2 days', 'Completed', AppColors.textLight),
  ...
  Widget _itineraryTile(String title, String subtitle, String status, Color statusColor) {
    return Container(
