                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(color: Colors.black.withAlpha(153), borderRadius: BorderRadius.circular(AppRadius.pill)),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        CircleAvatar(radius: 24, backgroundColor: AppColors.merchantAmber.withAlpha(26), child: const Icon(Icons.store, color: AppColors.merchantAmber)),
                      ...
                      children: widget.product.variants.map((v) => GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: _selectedVariant == v ? AppColors.merchantAmber.withAlpha(26) : Colors.white,
