...
class SosHelpdeskScreen extends StatelessWidget {
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(color: Colors.black.withAlpha(76), blurRadius: 20, spreadRadius: 5),
                        ],
                      ),
                      child: Column(
  ...
  Widget _hotlineCard(IconData icon, String title, String number, Color color) {
    return Container(
      ...
      decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(AppRadius.lg), border: Border.all(color: color.withAlpha(76))),
      child: Row(
        children: [
          Container(
